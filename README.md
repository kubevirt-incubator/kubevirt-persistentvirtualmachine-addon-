...
[Kubevirt](http://kubevirt.io) and provide controller and API for controlling
the persistent VM.

This addon is designed to work in tandem with the [Kubevirt](http://kubevirt.io). 
...
And finally this addon provides the custom controller for handling the changes
of state of persistent VM resource.
