...
import (
	...
	scheme "github.com/kubevirt-incubator/persistentvirtualmachine-addon/pkg/client/clientset/versioned/scheme"
...
func newPVMs(c *PersistentvirtualmachinesV1alpha1Client, namespace string) *pVMs {
	return &pVMs{
		client: c.RESTClient(),
		ns:     namespace,
	}
