...
type FakePVMs struct {
	Fake *FakePersistentvirtualmachinesV1alpha1
	ns   string
}

var pvmsResource = schema.GroupVersionResource{Group: "persistentvirtualmachines.kubevirt.io", Version: "v1alpha1", Resource: "pvms"}

var pvmsKind = schema.GroupVersionKind{Group: "persistentvirtualmachines.kubevirt.io", Version: "v1alpha1", Kind: "PVM"}
