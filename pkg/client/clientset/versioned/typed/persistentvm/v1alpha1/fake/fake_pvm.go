...
type FakePVMs struct {
	Fake *FakePersistentvmV1alpha1
	ns   string
}

var pvmsResource = schema.GroupVersionResource{Group: "persistentvm.kubevirt.io", Version: "v1alpha1", Resource: "pvms"}

var pvmsKind = schema.GroupVersionKind{Group: "persistentvm.kubevirt.io", Version: "v1alpha1", Kind: "PVM"}
