...
import (
	persistentvm_v1alpha1 "github.com/kubevirt-incubator/persistentvirtualmachine-addon/pkg/apis/persistentvm/v1alpha1"
	...
	v1alpha1 "github.com/kubevirt-incubator/persistentvirtualmachine-addon/pkg/client/listers/persistentvirtualmachines/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				return client.PersistentvirtualmachinesV1alpha1().PVMs(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				return client.PersistentvirtualmachinesV1alpha1().PVMs(namespace).Watch(options)
			},
		},
